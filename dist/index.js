...
function columnResizing(ref) {
  ...
  var gridWidth = ref.gridWidth; if ( gridWidth === void 0 ) gridWidth = 1;
  ...
  var plugin = new prosemirrorState.Plugin({
    ...
    props: {
      ...
      handleDOMEvents: {
        ...
        mousedown: function mousedown(view, event) { handleMouseDown$1(view, event, cellMinWidth, gridWidth); }
      },
...
function handleMouseDown$1(view, event, cellMinWidth, gridWidth) {
  var pluginState = key$1.getState(view.state);
  ...
  function move(event) {
    ...
    var pluginState = key$1.getState(view.state);
    var dragged = draggedWidth(pluginState.dragging, event, cellMinWidth, gridWidth);
